...
/*   COMENTED OUT SO I CAN PUT WAL COLORS INSTEAD
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", sel_fg, "-nf", norm_fg, "-sb", sel_bg, "-sf", norm_bg, NULL };
